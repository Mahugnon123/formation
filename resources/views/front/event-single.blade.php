  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 mb-4">
        <img src="../theme/images/events/event-single.jpg" alt="event thumb" class="img-fluid w-100">
      </div>
    </div>
    <!-- event info -->
    <div class="row align-items-center mb-5">
      ...
      <div class="col-lg-3 text-lg-right text-left">
        <a href="/event-single" class="btn btn-primary">Apply now</a>
      </div>
      <!-- border -->
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="media">
          <img class="mr-3 img-fluid" src="../theme/images/event-speakers/speaker-1.jpg" alt="speaker">
      ...
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="media">
          <img class="mr-3 img-fluid" src="../theme/images/event-speakers/speaker-2.jpg" alt="speaker">
          <div class="media-body">
      ...
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="media">
          <img class="mr-3 img-fluid" src="../theme/images/event-speakers/speaker-3.jpg" alt="speaker">
          <div class="media-body">
      ...
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="media">
          <img class="mr-3 img-fluid" src="../theme/images/event-speakers/speaker-4.jpg" alt="speaker">
          <div class="media-body">
...
<section class="section pt-0">
  ...
  <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
    <div class="card border-0 rounded-0 hover-shadow">
      <div class="card-img position-relative">
        <img class="card-img-top rounded-0" src="../theme/images/events/event-2.jpg" alt="event thumb">
  ...
  <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
    <div class="card border-0 rounded-0 hover-shadow">
      <div class="card-img position-relative">
        <img class="card-img-top rounded-0" src="../theme/images/events/event-3.jpg" alt="event thumb">
