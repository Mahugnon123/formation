 ...
 <br>
  ...
  <div class="col-md-12 my-2">
    <button class="btn btn-primary btn-sm col-sm-2 col-5 offset-1" type="button" onclick="addnewbesoin()"><ion-icon name='add-outline'></ion-icon> Nouveau contenu</button>
                
    <button class="btn btn-danger btn-sm col-sm-2 col-5" type="button" onclick="deletebesoin()"><ion-icon name='trash-outline'></ion-icon> Supprimer le contenu</button>
  </div>
