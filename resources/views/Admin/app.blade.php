        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1" style="background-color: #1a1a37; color: white;">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <!-- <li class="menu-item">
                  <a href="{{ url('/formations/')}}" class="menu-link">
                    <div data-i18n="Without menu">Toutes les formations</div>
                  </a>
                </li> -->
                
                 <li class="menu-item">
                  <a href="{{ url('/users')}}" class="menu-link">
                    <div data-i18n="Container">Les  utilisateurs</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="{{ url('/categorie')}}" class="menu-link">
                    <div data-i18n="Container">Les Categories</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="layouts-without-navbar.html" class="menu-link">
                    <div data-i18n="Without navbar">Les Formations</div>
                  </a>
                </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="pages-account-settings-account.html" class="menu-link">
                    <div data-i18n="Account">Formations</div>
                  </a>
                </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{asset(Auth()->user()->photo_profil)}}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
