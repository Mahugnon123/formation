    ...
    <div class="container">
      <div class="row no-gutters">
        ...
        <li class="list-inline-item">
          <a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block" href="notice">Forum</a></li>
            @if(Auth::check())
            @php($url = (Auth::user()->role_id==1)? '/apprenant':'/formateur')
            <li class="list-inline-item"><a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block" href=" {{$url}} ">
            <img
