    ...
    <div class="row">
      <div class="col-12">
        <div class="d-flex align-items-center section-title justify-content-between">
          <h2 class="mb-0 text-nowrap mr-3">Nos formations les plus </h2>
...
<div class="row justify-content-center">
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      <img class="card-img-top rounded-0" src="P_20161125_113006.jpg" alt="course thumb">
      <div class="card-body">
        ...
        <a href="course-single">
          <h4 class="card-title">Fabrication de Tracteur</h4>
        </a>
        <p class="card-text mb-4"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
          incididunt ut labore et dolore magna.</p><p class="card-text mb-4">25$</p>
        <a href="course-single" class="btn btn-primary btn-sm">S'inscrire</a>
      </div>
    </div>
  </div>
