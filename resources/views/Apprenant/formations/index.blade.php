...
<div class="container-fluid mt-3">
        <h2 class="mb-5 text-info">Suivi des formations</h2>
          <div class="row">
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Inscrire</h5>
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Since 1 month</span>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Commencer</h5>
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Since 1 week</span>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Terminer</h5>
                      <span class="h2 font-weight-bold mb-0">924</span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                      <i class="bi bi-person-check-fill"></i>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue" class="bi bi-person-check-fill" viewBox="0 0 16 16">
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Certifiées</h5>
    ...
    <thead>
        <tr>
            <th class="table-secondary">Formation</th>
            <th class="table-success">Types</th>
            <th class="table-info">Status</th>
            <th class="table-light">Operation</th>
